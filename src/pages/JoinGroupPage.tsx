...
export default function JoinGroupPage() {
  ...
  return (
    <div style={{
      ...
      background: "#F5EFE0", fontFamily: FONT, padding: 24,
    }}>
      <div style={{
        ...
        {loading ? (
          <div style={{ color: "#A8957B", fontSize: 14 }}>Looking up invite...</div>
        ) : error ? (
          <>
            <div style={{ fontSize: 48, marginBottom: 12 }}>😕</div>
            <div style={{ fontSize: 18, fontWeight: 800, color: "#1E130A", marginBottom: 8 }}>{error}</div>
            <button onClick={() => navigate("/groups")} style={{
              padding: "12px 24px", borderRadius: 12, border: "none",
              background: "#1E130A", color: "#fff", fontFamily: FONT,
          ...
          <>
            <div style={{
              width: 72, height: 72, borderRadius: 22, background: "#EEF5E5",
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: 36, margin: "0 auto 16px",
            }}>🏌️</div>
            <div style={{ fontSize: 14, color: "#A8957B", marginBottom: 4 }}>You've been invited to join</div>
            <div style={{ fontSize: 22, fontWeight: 800, color: "#1E130A", marginBottom: 6 }}>{group.name}</div>
            {group.description && (
              <div style={{ fontSize: 13, color: "#8B7355", marginBottom: 16 }}>{group.description}</div>
            )}
            <div style={{ fontSize: 12, color: "#A8957B", marginBottom: 20 }}>
            ...
            <button onClick={() => navigate("/groups")} style={{
              ...
              color: "#A8957B", fontFamily: FONT, fontSize: 13, cursor: "pointer",
            }}>Maybe later</button>
          </>
        ) : null}
      </div>
