...
const AUSTIN_COURSES = [
  ...
  // === PRIVATE CLUBS ===
  { id: "westlake", name: "Westlake Country Club", city: "Austin", type: "private", pars: [5,4,4,3,4,4,4,3,4,3,5,4,4,4,4,5,4,3], handicaps: [3,7,11,15,5,9,13,17,1,16,18,8,6,12,14,2,4,10], tees: [{ name: "Black", slope: 141, rating: 74.9, yardage: 6935 }, { name: "Gold", slope: 138, rating: 70.9, yardage: 6224 }, { name: "Silver", slope: 124, rating: 66.8, yardage: 5589 }, { name: "Violet", slope: 113, rating: 63.8, yardage: 4937 }] },
